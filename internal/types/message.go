...
type Message struct {
	...
	// Feedback is the current principal's evaluation. It is hydrated at read
	// time and is not stored on the messages table.
	Feedback *MessageFeedbackView `json:"feedback,omitempty" gorm:"-"`
