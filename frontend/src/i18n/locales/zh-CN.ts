export default {
  ...
  messageFeedback: {
    ...
    canceled: "评价已取消",
    saveFailed: "评价提交失败",
    reasonTitle: "这条回答哪里需要改进？",
    reasonHint: "你的反馈会同步归因到本次回答引用的知识片段。",
  ...
  chunkFeedback: {
    title: "问答反馈",
    description: "查看知识片段的赞踩表现、关联会话和召回权重，定位需要优化的知识源。",
    searchPlaceholder: "搜索文档或片段内容",
    empty: "暂无匹配的片段反馈数据",
    loadFailed: "加载片段反馈统计失败",
    viewLogs: "权重日志",
    reset: "重置",
    resetTitle: "重置片段反馈",
    resetConfirm: "将清空该片段的赞踩归因并把召回权重恢复为 1.00。其他关联片段不受影响。",
    resetSuccess: "片段反馈和权重已重置",
    resetFailed: "重置片段反馈失败",
    logsTitle: "权重变更日志",
    logsEmpty: "该片段暂无权重变更",
    logsLoadFailed: "加载权重日志失败",
    weight: "召回权重",
    rate: "好评率",
    columns: {
      chunk: "知识片段",
    ...
    triggers: {
      ...
      dislike: "用户点踩",
      switch_to_like: "改为点赞",
      switch_to_dislike: "改为点踩",
      cancel: "取消评价",
      adminReset: "管理员重置",
    },
    config: {
      title: "反馈驱动的召回权重",
      description: "达到最小评价数后，系统按好评率自动调整片段的检索排序权重。",
      positiveThreshold: "提升权重阈值",
      negativeThreshold: "降低权重阈值",
      optimizationThreshold: "标记待优化阈值",
      boostWeight: "提升倍率",
      reduceWeight: "降低倍率",
      minCount: "最小评价数",
    },
