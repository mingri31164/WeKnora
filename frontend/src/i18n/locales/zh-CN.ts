export default {
  workbench: {
    artifactKinds: { presentation: '演示文稿', web_page: '网页', spreadsheet: '电子表格', document: '文档', image: '图片', text: '文本', other: '文件' },
    title: '工作台', terminal: '终端', files: '文件', artifacts: '产物', audit: '审计',
    open: '打开工作台',
    reinitialize: '重新初始化沙箱',
    reinitializeHint: '使用当前会话已绑定的配置重试初始化，不更换配置。',
    refresh: '刷新', connect: '连接', disconnect: '断开', clearOutput: '清空输出',
    terminalOutput: '终端输出', command: '命令', run: '运行', interrupt: '中断',
    outputLimit: '输出已达上限。', noReplay: '连接已断开，命令不会自动重试。',
    exitCode: '退出码 {code}', back: '返回', parentDirectory: '上级目录', upload: '上传文件',
    newDirectory: '新建目录', emptyDirectory: '目录为空', fileActions: '文件操作',
    destination: '相对于 /workspace/output 的目标路径', rename: '重命名 / 移动', delete: '删除', download: '下载',
    deleteConfirm: '删除 {path}？目录必须为空。', invalidPath: '请输入相对路径，不得包含 ..、空路径段或反斜杠。',
    noOverwrite: '目标已存在，不允许覆盖。', singleFileOnly: '每次拖入一个文件，不支持上传文件夹。',
    fileTooLarge: '文件超过 {size}。', requestFailed: '请求失败，请重试或检查权限。',
    ...
    states: {
      ...
      unbound: '尚未绑定沙箱', policy_denied: '工作空间策略禁止访问',
      unavailable: '工作台不可用', unsupported: '不支持此沙箱',
      capability_unavailable: '沙箱能力不可用，请检查配置后重试初始化。',
    },
    connection: { disconnected: '未连接', connecting: '连接中', ready: '空闲', starting: '启动中', running: '运行中' },
  },
  localBrowser: {
    pipOpen: "弹出悬浮窗",
    pipReturn: "返回对话小窗",
