export default {
  ...
  knowledgeBase: {
    ...
    batchCancelParse: "停止解析",
    confirmBatchCancelParse: "停止解析",
    confirmBatchCancelParseDocument: "确定停止选中的 {count} 条知识的解析吗？已完成的条目会被自动跳过。",
    batchCancelParseSuccess: "已停止 {count} 条解析",
    batchCancelParseSkipped: "已停止 {cancelled} 条，跳过 {skipped} 条（非进行中）",
    batchCancelParseNone: "选中项中没有正在解析的知识",
    batchCancelParseFailed: "批量停止解析失败",
    buildProgressLabel: "构建中 {completed}/{total}",
    buildProgressAllDone: "全部完成 {total}/{total}",
    statusCompleted: "已完成",
