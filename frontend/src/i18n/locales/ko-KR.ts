export default {
  ...
  messageFeedback: {
    ...
    dislike: "싫어요",
    saved: "피드백이 제출되었습니다",
    canceled: "피드백이 취소되었습니다",
    saveFailed: "피드백을 제출하지 못했습니다",
    reasonTitle: "어떤 점을 개선해야 하나요?",
    reasonHint: "피드백은 이 답변이 인용한 모든 지식 청크에 반영됩니다.",
    reasonPlaceholder: "문제를 설명해 주세요",
    reasons: {
      inaccurate: "부정확함",
      outdated: "오래된 내용",
      incomplete: "불완전함",
  ...
  chunkFeedback: {
    title: "Q&A 피드백",
    description: "지식 청크의 평가, 관련 대화 및 검색 가중치를 확인하여 개선할 소스를 찾습니다.",
    searchPlaceholder: "문서 또는 청크 내용 검색",
    empty: "일치하는 청크 피드백이 없습니다",
    loadFailed: "청크 피드백 통계를 불러오지 못했습니다",
    viewLogs: "가중치 로그",
    reset: "초기화",
    resetTitle: "청크 피드백 초기화",
    resetConfirm: "이 청크의 피드백 귀속을 지우고 검색 가중치를 1.00으로 복원합니다. 다른 청크에는 영향을 주지 않습니다.",
    resetSuccess: "청크 피드백과 가중치가 초기화되었습니다",
    resetFailed: "청크 피드백을 초기화하지 못했습니다",
    logsTitle: "가중치 변경 로그",
    logsEmpty: "가중치 변경 내역이 없습니다",
    logsLoadFailed: "가중치 로그를 불러오지 못했습니다",
    weight: "검색 가중치",
    rate: "긍정 평가율",
    columns: {
      chunk: "지식 청크", rate: "긍정 평가율", votes: "좋아요 / 싫어요", sessions: "관련 대화",
      weight: "검색 가중치", status: "상태", reasons: "싫어요 이유",
    },
    filters: { allQuality: "모든 평가율", below50: "50% 미만", below80: "80% 미만", allStatus: "모든 상태" },
    status: { normal: "정상", pending_optimization: "최적화 필요" },
    triggers: {
      like: "사용자 좋아요", dislike: "사용자 싫어요", switch_to_like: "좋아요로 변경",
      switch_to_dislike: "싫어요로 변경", cancel: "피드백 취소", adminReset: "관리자 초기화",
    },
    config: {
      title: "피드백 기반 검색 가중치", description: "최소 평가 수 이후 긍정 평가율에 따라 청크 순위 가중치를 자동 조정합니다.",
      positiveThreshold: "가중치 상향 기준", negativeThreshold: "가중치 하향 기준",
      optimizationThreshold: "최적화 필요 기준", boostWeight: "상향 배수",
      reduceWeight: "하향 배수", minCount: "최소 평가 수",
    },
  },
};
