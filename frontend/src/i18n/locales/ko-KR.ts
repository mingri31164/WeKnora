export default {
  workbench: {
    artifactKinds: { presentation: '프레젠테이션', web_page: '웹 페이지', spreadsheet: '스프레드시트', document: '문서', image: '이미지', text: '텍스트', other: '파일' },
    title: '워크벤치', terminal: '터미널', files: '파일', artifacts: '결과물', audit: '감사',
    open: '워크벤치 열기',
    reinitialize: '샌드박스 다시 초기화',
    reinitializeHint: '이 세션에 연결된 설정을 변경하지 않고 초기화를 다시 시도합니다.',
    refresh: '새로고침', connect: '연결', disconnect: '연결 해제', clearOutput: '출력 지우기',
    terminalOutput: '터미널 출력', command: '명령어', run: '실행', interrupt: '중단',
    outputLimit: '출력 한도에 도달했습니다.', noReplay: '연결이 끊겼습니다. 명령은 자동으로 재실행되지 않습니다.',
    exitCode: '종료 코드 {code}', back: '뒤로', parentDirectory: '상위 디렉터리', upload: '파일 업로드',
    newDirectory: '디렉터리 만들기', emptyDirectory: '디렉터리가 비어 있습니다', fileActions: '파일 작업',
    destination: '/workspace/output 기준 상대 경로', rename: '이름 변경 / 이동', delete: '삭제', download: '다운로드',
    deleteConfirm: '{path}을(를) 삭제할까요? 디렉터리는 비어 있어야 합니다.', invalidPath: '.., 빈 경로 구간, 역슬래시가 없는 상대 경로를 입력하세요.',
    noOverwrite: '대상이 이미 존재합니다. 덮어쓸 수 없습니다.', singleFileOnly: '한 번에 파일 하나만 놓으세요. 폴더 업로드는 지원하지 않습니다.',
    fileTooLarge: '파일이 {size}을(를) 초과합니다.', requestFailed: '요청에 실패했습니다. 다시 시도하거나 권한을 확인하세요.',
    ...
    states: {
      ...
      unbound: '연결된 샌드박스 없음', policy_denied: '워크스페이스 정책으로 차단됨',
      unavailable: '워크벤치 사용 불가', unsupported: '지원하지 않는 샌드박스',
      capability_unavailable: '샌드박스 기능을 사용할 수 없습니다. 설정을 확인한 후 초기화를 다시 시도하세요.',
    },
    connection: { disconnected: '연결 끊김', connecting: '연결 중', ready: '대기 중', starting: '시작 중', running: '실행 중' },
  },
  localBrowser: {
    pipOpen: "미리보기 팝업 열기",
