export default {
  ...
  organization: {
    ...
    settings: {
      ...
      permissionCalcFormula:
        "스페이스 권한은 공유 시 설정되며, 적용 권한은 스페이스 권한과 내 역할 중 낮은 값입니다",
      permissionCalcTip:
        "적용 권한은 스페이스 권한과 내 역할 중 낮은 값이며, 읽기 전용 구성원은 이 지식베이스에 읽기만 가능합니다.",
      inviteMembers: "회원 초대",
    ...
    share: {
      ...
      searchPlaceholder: "스페이스 검색…",
      loading: "로딩 중…",
      emptySearch: "「{q}」와(과) 일치하는 스페이스가 없습니다",
      addShareDialogTitle: "스페이스에 공유",
      unshareAction: "공유 해제",
      columns: {
        space: "스페이스",
        permission: "권한",
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: "앱의 지식베이스/파일 읽기 권한과 작업자의 대상 지식베이스 접근 권한을 확인하세요.",
    ...
    guideStep1_dingtalk: "DingTalk Open Platform에서 기업 내부 앱을 만듭니다",
    guideStep2_dingtalk: "지식베이스, 노드, 기업 파일 읽기 권한을 부여하고 앱 버전을 게시합니다",
    guideStep3_dingtalk: "작업자가 대상 지식베이스에 접근할 수 있는지 확인한 후 다시 불러옵니다",
    permissionDocLink: "페이슈 위키 권한 설정 문서 보기",
    permissionDocLink_dingtalk: "DingTalk 지식베이스 API 문서 보기",
    ...
    syncError: {
      ...
      dingtalk_auth_or_permission: "DingTalk 인증 또는 권한 오류입니다. 자격 증명, 앱 권한, 작업자 접근 권한을 확인하세요",
      dingtalk_rate_limited: "DingTalk API 요청 제한, 다음 동기화 시 다시 시도합니다",
      dingtalk_timeout: "DingTalk 요청 시간 초과, 다음 동기화 시 다시 시도합니다",
      dingtalk_unavailable: "DingTalk 서비스를 일시적으로 사용할 수 없습니다. 다음 동기화 시 다시 시도합니다",
      dingtalk_api_error: "DingTalk API 오류(code={code}), 다음 동기화 시 다시 시도합니다",
      dingtalk_api_error_generic: "DingTalk API 오류, 다음 동기화 시 다시 시도합니다",
    ...
    field: {
      ...
      operatorIdHint: "대상 지식베이스를 읽을 수 있는 사용자의 unionId를 입력하세요.",
    ...
    prereqBarText_dingtalk: "처음 사용하시나요? DingTalk 앱 설정 가이드를 확인하세요",
    prereqStep1Brief_dingtalk: "기업 내부 앱 만들기",
    prereqStep1Desc_dingtalk: "DingTalk Open Platform에서 앱을 만들고 Client ID와 Client Secret을 확인합니다.",
    prereqStep2Brief_dingtalk: "세 가지 읽기 권한 부여",
    prereqStep2Desc_dingtalk: "지식베이스 읽기, 노드 읽기, 기업 파일 읽기 권한을 부여하고 앱 버전을 게시합니다.",
    prereqStep3Brief_dingtalk: "작업자 UnionID 준비",
    prereqStep3Desc_dingtalk: "대상 지식베이스와 문서를 읽을 수 있는 사용자의 unionId를 사용합니다.",
