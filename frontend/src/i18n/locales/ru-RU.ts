export default {
  ...
  knowledgeFolder: {
    ...
    moveDocument: 'Переместить в папку',
    selectTarget: 'Выберите целевую папку',
    namePlaceholder: 'Имя папки',
    deleteConfirm: 'Удалить папку «{name}»?',
    notEmpty: 'Можно удалить только пустую папку',
    operationFailed: 'Не удалось выполнить операцию',
    created: 'Папка создана',
    renamed: 'Папка переименована',
    moved: 'Папка перемещена',
    deleted: 'Папка удалена',
    documentsMoved: 'Документы перемещены',
    scopeTitle: 'Выберите область папок',
    scopeHint: 'Поиск будет выполнен в выбранных папках и всех их подпапках.',
    entireKnowledgeBase: 'Вся база знаний',
    selectedCount: 'Выбрано папок: {count}',
  },
  knowledgeBase: {
    title: 'База знаний',
