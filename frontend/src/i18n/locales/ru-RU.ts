export default {
  ...
  knowledgeBase: {
    ...
    batchCancelParse: 'Остановить обработку',
    confirmBatchCancelParse: 'Остановить обработку',
    confirmBatchCancelParseDocument: 'Остановить обработку выбранных элементов ({count})? Уже завершённые элементы пропускаются автоматически.',
    batchCancelParseSuccess: 'Остановлено задач обработки: {count}',
    batchCancelParseSkipped: 'Остановлено: {cancelled}, пропущено: {skipped} (не в процессе)',
    batchCancelParseNone: 'Среди выбранных нет обрабатываемых элементов',
    batchCancelParseFailed: 'Ошибка пакетной остановки обработки',
    buildProgressLabel: 'Построение {completed}/{total}',
    buildProgressAllDone: 'Всё готово {total}/{total}',
...
/example\.(net|org)/`,
  ...
  integrations: {
    ...
    api: {
      ...
      apiKeyAccessTypeHint: '«База знаний» работает в пределах области БЗ на выбранном ниже уровне прав; «Полный доступ арендатора» дополнительно открывает все API уровня арендатора, такие как модели и источники данных.',
      accessTypeKnowledgeBase: 'База знаний',
      accessTypeTenantFull: 'Полный доступ арендатора',
      apiKeyPermissionLevel: 'Уровень прав',
      apiKeyAccessRoleHint: 'Первые три роли ограничены операциями с базами знаний; «Полный доступ арендатора» дополнительно открывает API уровня арендатора, такие как модели и источники данных.',
      accessRoleViewer: 'Чтение БЗ',
      accessRoleContributor: 'Чтение и запись БЗ',
      accessRoleAdmin: 'Администратор БЗ',
      accessRoleOwner: 'Полный доступ арендатора',
      ...
      accessRoleAdminDesc: 'Управление базами знаний в выбранном диапазоне, включая деструктивные операции, такие как очистка базы знаний; настройки уровня арендатора недоступны.',
	      accessRoleOwnerDesc: 'Полный доступ, эквивалент владельца арендатора: доступны все API уровня арендатора (модели, векторные хранилища, источники данных, каналы, ...). Не ограничивается диапазоном баз знаний.',
	      ...
	      apiKeyCapabilityGroupTenant: 'Настройки арендатора',
	      apiKeyCapabilitySelectGroup: 'Выбрать всё',
	      apiKeyCapabilityClearGroup: 'Очистить',
	      capabilityTenantFull: 'Полный доступ арендатора',
	      capabilityTenantFullHint: 'Разрешает все API уровня арендатора, включая модели, векторные хранилища, источники данных и каналы. Диапазон баз знаний не применяется.',
      ...
      capabilityManageKbsHint: 'Позволяет обновлять или удалять существующие базы знаний и менять их конфигурацию в выбранной области. Не разрешает создавать новые базы знаний.',
	      ...
	      capabilityMessageHistoryHint: 'Позволяет искать историю чатов арендатора и читать статистику истории. Не даёт доступ к настройкам арендатора.',
	      ...
	      capabilityManageMembersHint: 'Просмотр и управление участниками арендатора, ролями, приглашениями и ссылками-приглашениями. Не включает управление API Key, удаление арендатора или передачу владения.',
	      ...
	      capabilityManageTenantSettings: 'Управление настройками арендатора',
	      capabilityManageTenantSettingsHint: 'Чтение и обновление интеграционных настроек арендатора: режим идентификации конечного пользователя API, настройки заголовков запросов и tenant KV. Не включает управление API Key, участниками, удаление арендатора или передачу владения.',
