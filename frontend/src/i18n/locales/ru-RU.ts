...
/example\.(net|org)/`,
  ...
  organization: {
    ...
    share: {
      ...
      loading: 'Loading…',
      emptySearch: 'No spaces matching "{q}"',
      addShareDialogTitle: 'Share to space',
  ...
  datasource: {
    ...
    noResourcesDesc_dingtalk: 'Проверьте права приложения на чтение базы знаний и файлов, а также доступ оператора к целевой базе.',
    ...
    guideStep1_dingtalk: 'Создайте внутреннее корпоративное приложение в DingTalk Open Platform',
    guideStep2_dingtalk: 'Выдайте права чтения базы знаний, узлов и корпоративных файлов, затем опубликуйте версию приложения',
    guideStep3_dingtalk: 'Убедитесь, что оператор имеет доступ к целевой базе знаний, и повторите загрузку',
    permissionDocLink: 'Документация по настройке прав доступа',
    permissionDocLink_dingtalk: 'Документация API базы знаний DingTalk',
    ...
    syncError: {
      ...
      dingtalk_auth_or_permission: 'Ошибка аутентификации или прав DingTalk; проверьте учётные данные, права приложения и доступ оператора',
      dingtalk_rate_limited: 'Превышен лимит API DingTalk; повтор при следующей синхронизации',
      dingtalk_timeout: 'Тайм-аут запроса DingTalk; повтор при следующей синхронизации',
      dingtalk_unavailable: 'DingTalk временно недоступен; повтор при следующей синхронизации',
      dingtalk_api_error: 'Ошибка API DingTalk (code={code}); повтор при следующей синхронизации',
      dingtalk_api_error_generic: 'Ошибка API DingTalk; повтор при следующей синхронизации',
    ...
    field: {
      ...
      operatorIdHint: 'Укажите unionId пользователя с доступом на чтение целевой базы знаний.',
    ...
    prereqBarText_dingtalk: 'Первое подключение? Откройте руководство по настройке DingTalk',
    prereqStep1Brief_dingtalk: 'Создайте внутреннее корпоративное приложение',
    prereqStep1Desc_dingtalk: 'Создайте приложение в DingTalk Open Platform и получите Client ID и Client Secret.',
    prereqStep2Brief_dingtalk: 'Выдайте три права на чтение',
    prereqStep2Desc_dingtalk: 'Выдайте права чтения базы знаний, узлов и корпоративных файлов, затем опубликуйте версию приложения.',
    prereqStep3Brief_dingtalk: 'Подготовьте UnionID оператора',
    prereqStep3Desc_dingtalk: 'Используйте unionId пользователя с доступом на чтение целевой базы знаний и документов.',
