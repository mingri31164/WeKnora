...
/example\.(net|org)/`,
  ...
  messageFeedback: {
    like: 'Нравится',
    dislike: 'Не нравится',
    saved: 'Отзыв отправлен',
    canceled: 'Отзыв отменён',
    saveFailed: 'Не удалось отправить отзыв',
    reasonTitle: 'Что можно улучшить?',
    reasonHint: 'Отзыв будет отнесён ко всем фрагментам знаний, использованным в ответе.',
  ...
  chunkFeedback: {
    title: 'Отзывы о Q&A',
    description: 'Оценки фрагментов, связанные диалоги и веса поиска помогают найти источники, требующие улучшения.',
    searchPlaceholder: 'Поиск по документам или фрагментам',
    empty: 'Подходящих данных нет',
    loadFailed: 'Не удалось загрузить статистику отзывов',
    viewLogs: 'Журнал весов',
    reset: 'Сбросить',
    resetTitle: 'Сбросить отзывы фрагмента',
    resetConfirm: 'Отзывы для этого фрагмента будут очищены, а вес поиска восстановлен до 1.00. Другие фрагменты не изменятся.',
    resetSuccess: 'Отзывы и вес фрагмента сброшены',
    resetFailed: 'Не удалось сбросить отзывы',
    logsTitle: 'Журнал изменений веса',
    logsEmpty: 'Изменений веса нет',
    logsLoadFailed: 'Не удалось загрузить журнал',
    weight: 'Вес поиска',
    rate: 'Доля положительных',
    columns: {
      chunk: 'Фрагмент знаний', rate: 'Доля положительных', votes: 'Нравится / не нравится',
      sessions: 'Диалоги', weight: 'Вес поиска', status: 'Статус', reasons: 'Причины',
    },
    filters: { allQuality: 'Все оценки', below50: 'Ниже 50%', below80: 'Ниже 80%', allStatus: 'Все статусы' },
    status: { normal: 'Норма', pending_optimization: 'Требует оптимизации' },
    triggers: {
      like: 'Положительный отзыв', dislike: 'Отрицательный отзыв', switch_to_like: 'Изменено на положительный',
      switch_to_dislike: 'Изменено на отрицательный', cancel: 'Отзыв отменён', adminReset: 'Сброс администратором',
    },
    config: {
      title: 'Вес поиска на основе отзывов', description: 'После минимального числа оценок вес фрагмента меняется по доле положительных отзывов.',
      positiveThreshold: 'Порог повышения', negativeThreshold: 'Порог снижения',
      optimizationThreshold: 'Порог оптимизации', boostWeight: 'Множитель повышения',
      reduceWeight: 'Множитель снижения', minCount: 'Минимум оценок',
    },
  },
}
