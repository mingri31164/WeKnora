export default {
  ...
  knowledgeFolder: {
    ...
    selectTarget: 'Select a target folder',
    ...
    scopeTitle: 'Choose folder scope',
    scopeHint: 'Questions will search the selected folders and all their subfolders.',
    entireKnowledgeBase: 'Entire knowledge base',
    selectedCount: '{count} folders',
  },
  knowledgeBase: {
