export default {
  workbench: {
    artifactKinds: { presentation: 'Presentation', web_page: 'Web page', spreadsheet: 'Spreadsheet', document: 'Document', image: 'Image', text: 'Text', other: 'File' },
    title: 'Workbench', terminal: 'Terminal', files: 'Files', artifacts: 'Artifacts', audit: 'Audit',
    open: 'Open workbench',
    reinitialize: 'Reinitialize sandbox',
    reinitializeHint: 'Retry initialization with the configuration already bound to this session.',
    refresh: 'Refresh', connect: 'Connect', disconnect: 'Disconnect', clearOutput: 'Clear output',
    terminalOutput: 'Terminal output', command: 'Command', run: 'Run', interrupt: 'Interrupt',
    outputLimit: 'Output limit reached.', noReplay: 'Disconnected. Commands are not replayed.',
    exitCode: 'Exit {code}', back: 'Back', parentDirectory: 'Parent directory', upload: 'Upload file',
    newDirectory: 'New directory', emptyDirectory: 'Directory is empty', fileActions: 'File actions',
    destination: 'Destination relative to /workspace/output', rename: 'Rename / move', delete: 'Delete', download: 'Download',
    deleteConfirm: 'Delete {path}? Directories must be empty.', invalidPath: 'Use a relative path without .., empty segments, or backslashes.',
    noOverwrite: 'Destination already exists. Overwrite is not allowed.', singleFileOnly: 'Drop one file at a time. Folder upload is not supported.',
    fileTooLarge: 'File exceeds {size}.', requestFailed: 'Request failed. Retry or check access.',
    ...
    states: {
      ...
      unbound: 'No sandbox bound', policy_denied: 'Blocked by workspace policy',
      unavailable: 'Workbench unavailable', unsupported: 'Sandbox not supported',
      capability_unavailable: 'Sandbox capabilities are unavailable. Retry initialization after checking the configuration.',
    },
    connection: { disconnected: 'Disconnected', connecting: 'Connecting', ready: 'Idle', starting: 'Starting', running: 'Running' },
  },
  localBrowser: {
