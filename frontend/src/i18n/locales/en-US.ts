...
\
  ...
  messageFeedback: {
    ...
    saveFailed: 'Failed to submit feedback',
    reasonTitle: 'What could be improved?',
    reasonHint: 'Your feedback will be attributed to every knowledge chunk cited by this answer.',
  ...
  chunkFeedback: {
    title: 'Q&A feedback',
    description: 'Review chunk ratings, related conversations, and recall weights to find knowledge sources that need improvement.',
    searchPlaceholder: 'Search documents or chunk content',
    empty: 'No matching chunk feedback',
    loadFailed: 'Failed to load chunk feedback statistics',
    viewLogs: 'Weight logs',
    reset: 'Reset',
    resetTitle: 'Reset chunk feedback',
    resetConfirm: 'This clears feedback attribution for this chunk and restores its recall weight to 1.00. Other cited chunks are unaffected.',
    resetSuccess: 'Chunk feedback and weight reset',
    resetFailed: 'Failed to reset chunk feedback',
    logsTitle: 'Weight change log',
    logsEmpty: 'No weight changes for this chunk',
    logsLoadFailed: 'Failed to load weight logs',
    weight: 'Recall weight',
    rate: 'Positive rate',
    columns: {
      ...
      weight: 'Recall weight',
      status: 'Status',
      reasons: 'Dislike reasons',
    },
    filters: {
      allQuality: 'All positive rates',
      below50: 'Below 50%',
      below80: 'Below 80%',
    ...
    triggers: {
      ...
      switch_to_like: 'Changed to like',
      switch_to_dislike: 'Changed to dislike',
      cancel: 'Feedback canceled',
      adminReset: 'Administrator reset',
    },
    config: {
      title: 'Feedback-driven recall weights',
      description: 'After the minimum number of evaluations, chunk ranking weights adjust automatically from the positive rate.',
      positiveThreshold: 'Boost threshold',
      negativeThreshold: 'Reduction threshold',
      optimizationThreshold: 'Needs-optimization threshold',
      boostWeight: 'Boost multiplier',
      reduceWeight: 'Reduction multiplier',
      minCount: 'Minimum evaluations',
    },
  },
}
