export default {
  ...
  knowledgeBase: {
    ...
    confirmBatchCancelParse: 'Stop parsing',
    confirmBatchCancelParseDocument: 'Stop parsing the {count} selected item(s)? Items that already finished are skipped automatically.',
    batchCancelParseSuccess: 'Stopped {count} parsing task(s)',
    batchCancelParseSkipped: 'Stopped {cancelled}, skipped {skipped} (not in progress)',
    batchCancelParseNone: 'No items are currently being parsed',
    batchCancelParseFailed: 'Batch stop parsing failed',
    buildProgressLabel: 'Building {completed}/{total}',
    buildProgressAllDone: 'All done {total}/{total}',
...
\
  ...
  integrations: {
    ...
    api: {
      ...
      apiKeyAccessTypeHint: "\"Knowledge base\" operates within the KB scope at the permission level below; \"Tenant full\" additionally unlocks every tenant-level API such as models and data sources.",
      accessTypeKnowledgeBase: "Knowledge base",
      accessTypeTenantFull: "Tenant full",
      apiKeyPermissionLevel: "Permission level",
      apiKeyAccessRoleHint: "The first three roles are limited to knowledge-base operations; \"Tenant Full\" also unlocks tenant-level APIs such as models and data sources.",
      accessRoleViewer: "KB Read",
      accessRoleContributor: "KB Write",
      accessRoleAdmin: "KB Admin",
      accessRoleOwner: "Tenant Full",
      ...
      accessRoleAdminDesc: "Manage knowledge bases, including destructive operations like clearing a KB, within the selected scope; no tenant-level configuration.",
	      accessRoleOwnerDesc: "Full access, equivalent to a tenant owner: may call every tenant-level API (models, vector stores, data sources, channels, ...). Not limited by knowledge-base scope.",
	      ...
	      apiKeyCapabilityGroupTenant: 'Tenant configuration',
	      apiKeyCapabilitySelectGroup: 'Select all',
	      apiKeyCapabilityClearGroup: 'Clear',
	      capabilityTenantFull: 'Tenant full access',
	      capabilityTenantFullHint: 'Allow every tenant-level API, including models, vector stores, data sources and channels. Knowledge-base scope does not apply.',
      ...
      capabilityManageKbsHint: 'Let this key update or delete existing knowledge bases and change their initialization/configuration within the selected scope. It does not create new knowledge bases.',
	      ...
	      capabilityMessageHistoryHint: 'Let this key search tenant chat history and read chat-history stats. It does not grant tenant configuration access.',
	      ...
	      capabilityManageMembersHint: 'List and manage tenant members, roles, invitations, and invite links. Does not include API key management, tenant deletion, or ownership transfer.',
	      ...
	      capabilityManageTenantSettings: 'Manage tenant settings',
	      capabilityManageTenantSettingsHint: 'Read and update tenant-level integration settings such as API end-user identity mode, request header configuration, and tenant KV settings. Does not include API key management, member management, tenant deletion, or ownership transfer.',
