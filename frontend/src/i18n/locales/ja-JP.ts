export default {
  workbench: {
    artifactKinds: { presentation: 'プレゼンテーション', web_page: 'ウェブページ', spreadsheet: 'スプレッドシート', document: '文書', image: '画像', text: 'テキスト', other: 'ファイル' },
    title: 'ワークベンチ', terminal: 'ターミナル', files: 'ファイル', artifacts: '成果物', audit: '監査',
    open: 'ワークベンチを開く',
    reinitialize: 'サンドボックスを再初期化',
    reinitializeHint: 'このセッションに関連付け済みの設定を変更せずに、初期化を再試行します。',
    refresh: '更新', connect: '接続', disconnect: '切断', clearOutput: '出力を消去',
    terminalOutput: 'ターミナル出力', command: 'コマンド', run: '実行', interrupt: '中断',
    outputLimit: '出力上限に達しました。', noReplay: '切断されました。コマンドは自動再実行されません。',
    exitCode: '終了コード {code}', back: '戻る', parentDirectory: '親ディレクトリ', upload: 'ファイルをアップロード',
    newDirectory: 'ディレクトリ作成', emptyDirectory: 'ディレクトリは空です', fileActions: 'ファイル操作',
    destination: '/workspace/output からの相対パス', rename: '名前変更 / 移動', delete: '削除', download: 'ダウンロード',
    deleteConfirm: '{path} を削除しますか？ディレクトリは空である必要があります。', invalidPath: '..、空の区切り、バックスラッシュを含まない相対パスを入力してください。',
    noOverwrite: '保存先は既に存在します。上書きはできません。', singleFileOnly: '一度に1つのファイルをドロップしてください。フォルダはアップロードできません。',
    fileTooLarge: 'ファイルが {size} を超えています。', requestFailed: 'リクエストに失敗しました。再試行するか権限を確認してください。',
    ...
    states: {
      ...
      unbound: 'サンドボックス未設定', policy_denied: 'ワークスペースのポリシーにより拒否されました',
      unavailable: 'ワークベンチを利用できません', unsupported: '未対応のサンドボックス',
      capability_unavailable: 'サンドボックスの機能を利用できません。設定を確認して初期化を再試行してください。',
    },
    connection: { disconnected: '未接続', connecting: '接続中', ready: '待機中', starting: '起動中', running: '実行中' },
  },
  localBrowser: {
